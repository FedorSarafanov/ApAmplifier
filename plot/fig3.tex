...
\begin{document}
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
	     ...
	     % \xdef\C{5e-8}
	     % \xdef\R{13000}
		\addplot +[mark=x, mark options={scale=1.5, line width=1pt}, line width=0.2pt,blue, only marks] plot [error bars/.cd, y dir = both, y explicit] table 
		[			    	    	    	
			x=uin, 
			y=uout, 
			% y error=dz
		] 
		{../data/common_collector.dat};
...
%        p1 =       0.887  (0.8779, 0.8962)
%        p2 =       17.66  (6.082, 29.24)
	     \addplot [samples=100, domain=0:4000, dashed, blue] {0.887*x+17.66};
		\addlegendentry{$U_\text{вых}=0.887\cdot U_\text{вх}+17.66$}
